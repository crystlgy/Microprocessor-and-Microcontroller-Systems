//basketball timer - maximum of 12 minutes
...
for (int matchcountdown = 60; matchcountdown <= 1160; matchcountdown += 100) {
if (matchcountdown == countdown_time) {
countdown_time += 40;
dig = IntToDigits(countdown_time);
}
}
...
for (int matchcountdown2 = 99; matchcountdown2 <= 1199; matchcountdown2 += 100) {
if (matchcountdown2 == countdown_time) {
countdown_time -= 40;
dig = IntToDigits(countdown_time);
}
}
